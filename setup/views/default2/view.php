...
<?php if ( isset($_SESSION['redirect']['url']) && $_SESSION['redirect']['url'] ): ?>
<meta http-equiv="refresh" content="3;url=<?php echo $_SESSION['redirect']['url']; ?>">
<?php endif; ?>
</head>
<body>
<div id="container">
	<div id="page">
		<div id="header">
			<h1><?php echo $this->config['title']; ?><?php if ( $this->config['version'] ): echo ' v' . $this->config['version']; endif; ?></h1>
			...
			<form action="" method="post" name="wizard">
				<div class="sections">
					<?php if ( isset($this->step['fields']) && $this->step['fields'] ): ?>
								...
								<div class="row">
									...
									<div class="field">
										...
										<?php elseif ( $field['type'] == 'password' ): ?>
											<input type="password" id="field_<?php echo $field['name']; ?>" name="<?php echo $field['name']; ?>" value="<?php echo isset($field['value']) ? htmlentities($field['value'], ENT_QUOTES, 'UTF-8') : ''; ?>" <?php echo $this->parse_attributes(isset($field['attributes']) ? $field['attributes'] : array(), array('class' => 'text')); ?> />
						...
						<?php endforeach; ?>
					<?php endif; ?>
					<?php if ( isset($_SESSION['redirect']['message']) && $_SESSION['redirect']['message'] ): ?>
						<div class="info">
							<?php echo $_SESSION['redirect']['message']; ?>
						</div>
					<?php endif; ?>
					<?php if ( isset($_SESSION['redirect']['url']) && $_SESSION['redirect']['url'] ): ?>
						<div class="info">
							If nothing happens for about a minute, <a href="<?php echo $_SESSION['redirect']['url']; ?>">click here</a> to continue.
						</div>
					<?php endif; ?>
				</div>
